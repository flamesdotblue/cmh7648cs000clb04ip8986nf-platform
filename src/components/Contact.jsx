      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          ...
          >
            ...
            <p className="mt-2 text-slate-300">Share a few details and our team will reach out to craft a proposal tailor-made under the blue moon.</p>
            <form className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4" onSubmit={(e)=>e.preventDefault()}>
              ...
              <div className="sm:col-span-2">
                <button type="submit" className="w-full sm:w-auto rounded-full bg-sky-500 hover:bg-sky-400 text-slate-900 font-semibold px-5 py-3 transition-colors">Request Proposal</button>
              </div>
            </form>
          </motion.div>
          ...
          >
            <div>
              ...
              <ul className="mt-4 space-y-3 text-slate-300">
                <li className="flex items-center gap-3"><Mail className="h-5 w-5 text-sky-300" /> hello@bluemoon tales.com</li>
